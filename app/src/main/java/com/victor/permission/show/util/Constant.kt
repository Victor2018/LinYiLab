...
object Constant {
    ...
    const val INTENT_PHONE_KEY                  = "INTENT_PHONE_KEY"
    const val INTENT_AD_DATA_KEY                = "INTENT_AD_DATA_KEY"
    const val INVITE_URL_KEY                    = "INVITE_URL_KEY"
    const val INTENT_PLAY_DATA_KEY              = "INTENT_PLAY_DATA_KEY"
    ...
    const val SHOW_BACK_KEY                     = "SHOW_BACK_KEY"
    ...
    const val COPY_ORDER_NO_KEY                 = "COPY_ORDER_NO_KEY"
    ...
    const val PACKAGE_GOODS_ID_KEY              = "PACKAGE_GOODS_ID_KEY"
    ...
    object Msg {
        ...
        const val VOD_PLAY_HIDE_CONTROL_VIEW                  = 0x1008
        const val VOD_PLAY_ON_STOP_TRACKING_TOUCH             = 0x1009
        const val HIDE_PLAY_S_Q_CTRL_VIEW                     = 0x1010
    }
    object Action {
